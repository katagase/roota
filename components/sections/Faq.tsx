...
const FAQS: { q: string; a: string }[] = [
  ...
  {
    q: "専用のAIエージェントは作れますか？費用はかかりますか？",
    a: "作れます。テンプレートから、作り方のレクチャーつきでご自身でも何個でも作成できます（無料）。さらに、御社の業務に合わせた専用エージェントの個別開発は、最初の1つが無料、2つ目以降は1個30,000円（税別）でご依頼いただけます。運用まで伴走します。",
  },
  {
